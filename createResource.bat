...
set TOMCAT=C:\Users\secon\Desktop\apache-tomcat-9.0.55\
set TOMCATLIB=%TOMCAT%lib\
set APP=%TOMCAT%webapps\demo050\
set APP_LIB=%APP%WEB-INF\lib\

set BATCHES=bin\spring-batch-core-4.3.4.jar;bin\spring-batch-infrastructure-4.3.4.jar;bin\javax.batch-api-1.0.jar;bin\micrometer-core-1.8.0.jar
set TOMCATJAR=%TOMCATLIB%servlet-api.jar;%TOMCATLIB%el-api.jar;%TOMCATLIB%jasper-el.jar
set OWN=build\libs\demo-0.5.0-SNAPSHOT-batch.jar;%BATCHES%;%TOMCATJAR%
