...
set CLASSES=bin\main;%JARS%;%OWN%
set CLASSPATH=%CLASSES%;%JARS% 

java -Dspring.profiles.active=batch ^
     -Dspring.batch.job.names=%JOBNAME% ^
     -cp %CLASSPATH% ^
     com.example.demo.BatchApplication ^
     -resourceCSV=%ARGS1%
